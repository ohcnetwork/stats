...
gem 'activeadmin_quill_editor', '>= 0.2.4'
...
gem 'devise', '~> 4.7', '>= 4.7.2' # User auth library.

# Reduces boot times through caching; required in config/boot.rb
gem 'bootsnap', '>= 1.4.2', require: false

gem 'activeadmin', '~> 2.11.0' # The administration framework for Ruby on Rails applications. https://activeadmin.info
